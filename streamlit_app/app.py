...
الصفحة الرئيسية: بانر، بطاقات KPI مخصصة، مقارنة أسبوعية، رسم زمني بعلامات أهم المعارك.
Run with: streamlit run app.py
(Use the sidebar to navigate to "Deep Analysis" and "Interactive Map" pages.)
"""
...
from common import (
    BATTLE_EVENTS, COLOR_DIVERGING, get_data, init_sidebar_controls,
    render_banner, render_kpi_card, t,
)

st.set_page_config(page_title="War Losses Dashboard — Overview", page_icon="📊", layout="wide", initial_sidebar_state="expanded")
